...
to stay within eSigner monthly signing limits.
...
Usage:
  # Dry run (default):
  python scripts/sign_windows.py <file>

  # Real signing:
  SIGN_ENABLED=true python scripts/sign_windows.py <file>
"""
import base64
import os
import re
...
def sign(path: str) -> None:
    ...
    # Jsign expects the TOTP secret in base64; SSL.com provides base32
