 ...
 *
 * @param cost     Raw cost in `fromCurrency`
 * @param fromCurrency Original currency of the cost
 * @param displayCurrency Target display currency ("ORIGINAL" = no conversion)
 * @param rate     CNY per USD exchange rate
 */
